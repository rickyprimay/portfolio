  ...
  const projects: Project[] = [
    {
      ...
      title: "Seni Kita",
      description:
        "Developed a Seni Kita Web with Laravel and React.js(with bun js for runtime javascript). The app features a list of popular art, art details, and search functionality, payment gatewat using Xendit, Check Ongkir price with Raja Ongkir, Realtime Tracking.",
      category: "Web",
    ...
    },
    {
      ...
      title: "Cook Smart",
      description:
        "Developed a Cook Smart app iOS using SwiftUI, SQLite, Firebase, and alamofire. The app features a list of popular recipes, recipe details, and search functionality. The app uses the Spoonacular API for recipe data and this app can control management eat on day/week/month.",
      category: "iOS",
    ...
    },
    {
      ...
      title: "Movie App",
      description:
        "Developed a movie app iOS with SwiftUI and alamofire. The app features a list of popular movies, movie details, and search functionality. The app uses the TMDB API for movie data. and this app i using package SDWebImage for image caching.",
      category: "iOS",
    ...
    },
    {
      ...
      description:
        "Developed a Seven Summit Central Java Guide App with SwiftUI. The app features a list of mountains, mountain details, and the ability to create custom hiking itineraries. The app uses MapKit for displaying interactive maps, route planning, and providing users with geolocation-based guidance.",
      category: "iOS",
    ...
    },
    {
      ...
      description:
        "Developed an expense tracker app with SwiftUI. The app features a list of transactions, transaction details, and the ability to add and delete transactions. The app uses Core Data for data persistence, Data Visualization Using Swift Charts, Advance Filters and Search, Device Biometric App Lock, App Widget.",
      category: "iOS",
    ...
    },
    {
      ...
      description:
        "Developed an online food ordering app with SwiftUI. The app features a list of cigarattes, cigarattes details, and the ability to add and delete cigarattes. The app uses Core Data for data persistence.",
      category: "iOS",
    ...
    },
    {
      ...
      description:
        "I'm building a website for the Hi-Technology 2023 Software Fair. The tech stack I used includes SvelteKit, Supabase, and PostgreSQL. For face recognition, I utilized the face-api.js API, and for geolocation, I implemented Mozilla Web API.",
      category: "Web",
      ghLink:
        "https://github.com/RickyPrima30/presensi-facerecognition-geolocation",
    ...
    },
    {
      ...
      title: "Weather App",
      description:
        "Developed a Weather app with Flutter. The app uses the OpenWeatherMap API for weather data. and using package Block for state management, Dio for HTTP request, and geo_locator for get location user.",
      category: "Flutter",
    ...
    },
    {
      ...
      description:
        "Developed a website for the registration of the National Seminar on Informatics Engineering. The website features a listing ticket pricing, directly to Form. The tech stack includes Laravel, TailwindCSS, and MySQL.",
      category: "Web",
    ...
    },
    {
      ...
      description:
        "Developed a website for the IT Competition quiz event. The website features a quiz and leaderboard. The tech stack includes PHP, BootStrap, and MySQL.",
      category: "Web",
    ...
    },
    {
      ...
      description:
        "Developed a website for the Hi-Technology 2024 Software & Hardware Fair. The website features a list of events, registration, and a countdown timer. The tech stack includes Laravel, TailwindCSS, and MySQL.",
      category: "Web",
    ...
    },
    {
      ...
      description:
        "I'm building a website for Code Jam Academy 2023. The project is an internal training website by Himpunan Mahasiswa Teknik Informatika. The theme of the project is Laravel 10 CRUD with Authentication. Tech stack: HTML5 and TailwindCSS.",
      category: "Web",
    ...
    },
    {
      ...
      title: "jARictku",
      description:
        "I'm building this website for the Program Penguatan Kapasitas Ormawa (PPK-O). I served as a developer on the team. This project features augmented reality technology using Laravel, TailwindCSS, MySQL, and AR.js.",
      category: "Web",
    ...
    },
    {
      ...
      title: "Ticketify",
      description:
        "Working on the development of Ticketify, an event ticketing website similar to Tiket.com and YesPlis. The website is still in the development phase. Tech stack includes Laravel for backend, React for frontend, and Midtrans as the payment gateway service.",
      category: "Web",
    ...
    },
    {
      ...
      description:
        "Developed a website, sirekampolkesyogya.com, as a freelance project for students at Poltekkes Yogyakarta to participate in PKM competitions. The website helps record and manage student activity scores.",
      category: "Web",
    ...
    },
    {
      ...
      description:
        "Developed a website, sumberdayafri.my.id, as a freelance project for students at Telkom University to complete their Thesis. The website serves as an information and resource platform for faculty students.",
      category: "Web",
    ...
    },
    {
      ...
      title: "Traffic Sense",
      description:
        "Participated in the DINACOM software competition by creating Traffic Sense, an app designed to find routes with minimal pollution. It uses Graphhopper API for maps and IoT with ESP-32 and MQ-135 sensors to monitor air quality. I developed the API for the mobile application.",
      category: "Android",
